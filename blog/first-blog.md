`````
{
  ...
  "cover_image": "/assets/blog/first-blog.png",
...
I contemplated just using a Medium blog since that would be easy... and I might even use it still.

LinkedIn doesn't seem like a great place to just post random things. You can do it, but it doesn't just feel right for me.

So, yeah I decided to go with this instead since it actually conveys a lot about my experience and expertise beyond the projects I work on.
...
I'm not much of a writer, but I'm a decent story teller, quick learner and I like to create things that I can share with the world even though not a lot of people may see it. I believe writing is a skill that improves with practice, so I'm hoping that this blog will help me become a better writer. 
